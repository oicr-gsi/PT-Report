...
`r if(show_construct){" for more information"}`
...
get_summary_table<-function(s){
  ...
  s_data<-summary[c("RawReads","AdapterTrimmedReads", "AdapterTrimmedBases","PassedReads", "MappedReads", "MappedPercent", "MeanReadLength", "MeanInsertSize", "InsertSizeSD"),,drop=F]
